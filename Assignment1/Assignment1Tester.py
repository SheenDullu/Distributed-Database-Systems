...
if __name__ == '__main__':
    try:
        ...
        with testHelper.getopenconnection(dbname=DATABASE_NAME) as conn:
            ...
            # [result, e] = testHelper.testroundrobinpartition(MyAssignment, RATINGS_TABLE, 2, conn, 0, ACTUAL_ROWS_IN_INPUT_FILE)
            # if result:
            ...
            # [result, e] = testHelper.testroundrobininsert(MyAssignment, RATINGS_TABLE, 111, 2, 1, conn, '1')
            # [result, e] = testHelper.testroundrobininsert(MyAssignment, RATINGS_TABLE, 101, 3, 5, conn, '0')
            # if result :
